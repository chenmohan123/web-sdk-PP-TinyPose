...
0.3.0 媒体参考组件为 [MediaWorkspace](../../demo/src/media/MediaWorkspace.tsx)，与图片界面共享模型与结果面板；参见[媒体生命周期](../media/README.md)。English: [MediaWorkspace](../../demo/src/media/MediaWorkspace.tsx) shares model controls and results with the image view; see the [media lifecycle example](../media/README.en.md).
