...
The 0.2.0 candidate adds 128×96 FP32, retained 256×192 FP32, and 128×96 W16A32 in the same desktop environment. All 12 WASM/WebGPU × main/Worker combinations passed; see the [browser comparison](../../reports/2026-09-17-variants/browser-comparison.json). W16A32's maximum reliable-point difference across backends was `0.001567px`. All three models and cards passed full GET at fixed revisions from both Hubs; see the [variant distribution receipt](../../reports/2026-09-17-variants/distribution-variants-verified.json). Candidate release still depends on the current build's real 24-row distribution acceptance.
