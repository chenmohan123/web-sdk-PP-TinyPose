...
- [x] npm 包、GitHub 仓库和公开 Demo 链接可用，0.2.0历史回读已归档；0.3.0仍须新回执。
- [ ] 当前产品完整测试、类型、SDK/Demo构建、打包及真实图片24组合、连续帧12组合验收通过。
- [ ] 独立分支审查、PR最新提交的CI通过。
...
- [ ] GitHub Release 使用不可变v0.3.0；npm公开包与CI产物逐字节一致，provenance内容回读通过。
...
- [ ] 线上Demo媒体基本流程、双语/390px与实际SDK推理回读通过。
- [ ] 门户同步真实版本、能力边界和独立链接，通过检查及部署核对。
